        ...
        <div className="signup-page-container">
            <div className="signup-page-form">
                ...
                <ModalMessage displayModal={displayModal} setDisplayModal={setDisplayModal}>
                    ...
                    <Modal.Footer>
                        {form.checkmarked ?
                            <button onClick={() => handleSignUp()} style={{ border: 'none', background: 'black', transition: '.5s', color: 'white', padding: '7px 15px', borderRadius: '20px' }}>Confirm</button>
                            :
                            <button style={{ border: 'none', background: 'rgba(0, 0, 0, 0.493)', transition: '.5s', color: 'white', padding: '7px 15px', borderRadius: '20px' }} disabled>Confirm</button>}
                    </Modal.Footer>
                </ModalMessage>
                <ModalMessage displayModal={successModal} setDisplayModal={setDisplaySuccessModal}>
                    <Modal.Header>
                ...
                <ModalMessage displayModal={failModal} setDisplayModal={setDisplayFailModal}>
                    <Modal.Header closeButton>
