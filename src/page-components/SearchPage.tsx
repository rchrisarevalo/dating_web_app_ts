...
import { SideScrollInnerWrapper, SideScrollWrapper } from '../components/Wrappers'
            ...
            {(!matched_profiles.pending && !pending && !algo_pending) ?
                (!matched_profiles.error && !error && !algo_error) ?
                    <>
                        ...
                        <SideScrollWrapper>
                            <SideScrollInnerWrapper>
                                {results.length !== 0 ?
                                    results.map((result, i) =>
                                        <figure id="profile-card" key={`profile-${i}`}>
                                            ...
                                            <div id="user-profile-figure-container">
                                                ...
                                                <i id="user-profile-details">{`${result.interests.slice(0, 100)}...`}</i>
                                                <br></br>
                                                <br></br>
                                                <br></br>
