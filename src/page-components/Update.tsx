...
export const Update = (props: UpdateProps) => {
  ...
  const { profile_page, profile_page_error, profile_page_pending, setProfile } =
    profileContext;
  ...
  useEffect(() => {
    ...
    setHandleDOB(
      `${profile_page.birth_year}-${MonthToNum(profile_page.birth_month)}-${
        profile_page.birth_date
      }`
    );
  ...
  const display_other_gender = () => {
    const gender_select = (
      document.getElementById("gender-select") as HTMLInputElement
    ).value;
  ...
  const submit_name_change = () => {
    ...
    const middle_name = (
      document.getElementById("middle_name") as HTMLInputElement
    ).value;
  ...
  const submit_username_change = () => {
    const new_username = (
      document.getElementById("new_username") as HTMLInputElement
    ).value;
  ...
  const submit_height_change = () => {
    const new_height_feet = (
      document.getElementById("new_height_feet") as HTMLInputElement
    ).value;
    const new_height_inches = (
      document.getElementById("new_height_inches") as HTMLInputElement
    ).value;
    ...
    if (new_height_feet.length > 0 && new_height_inches.length > 0) {
      setProfile({
        ...profile_page,
        height: `${new_height_feet}'${new_height_inches}''`,
      });
      ...
      fetch("http://localhost:5000/update_profile/height", {
        ...
        .catch((error) => {
          ...
          setProfile({
            ...profile_page,
            height: `${old_height_feet}'${old_height_inches}''`,
          });
        });
      setChange(false);
    }
  ...
  const submit_gender_change = () => {
    ...
    if (new_gender === "Other") {
      const other_gender = (
        document.getElementById("other_gender") as HTMLInputElement
      ).value;
  ...
  const submit_sexual_orientation_change = () => {
    const new_sexual_orientation = (
      document.getElementById("sexual-orientation-select") as HTMLInputElement
    ).value;
    ...
    if (new_sexual_orientation !== profile_page.sexual_orientation) {
      fetch("http://localhost:5000/update_profile/sexual_orientation", {
        ...
        .then((data) => {
          ...
          setProfile({
            ...profile_page,
            sexual_orientation: new_sexual_orientation,
          });
        })
        .catch((error) => {
          setProfile({
            ...profile_page,
            sexual_orientation: old_sexual_orientation,
          });
          console.log(error);
        });
      setChange(false);
  ...
  const submit_relationship_status_change = () => {
    const new_relationship_status = (
      document.getElementById("relationship-status-select") as HTMLInputElement
    ).value;
    ...
    if (new_relationship_status !== profile_page.relationship_status) {
      fetch("http://localhost:5000/update_profile/relationship_status", {
        ...
        .catch((error) => {
          ...
          setProfile({
            ...profile_page,
            relationship_status: old_relationship_status,
          });
        });
      setChange(false);
    }
  ...
  const submit_bio_change = () => {
    const new_bio = (document.getElementById("bio-change") as HTMLInputElement)
      .value;
  ...
  const handle_dob = () => {
    const dob = (document.getElementById("date-of-birth") as HTMLInputElement)
      .value;
              ...
              <div className="update-profile-option">
                ...
                {change ? (
                  <div className="change-inputs">
                    <form
                      ...
                      method="POST"
                      action="http://localhost:5000/update_profile_pic"
                    >
                      <input
                        type="file"
                        accept="image/*"
                  ...
                  <div className="change-inputs">
                    ...
                    {warning ? (
                      <p style={{ paddingTop: 50 }}>
                        <b>You have to be 18 years old to use this service.</b>
                      </p>
                    ) : (
                      <></>
                    )}
                ...
                {change ? (
                  <div className="change-inputs">
                    ...
                    <button
                      ...
                      id="change-username"
                      onClick={submit_username_change}
                    >
                      Submit
                    </button>
                  </div>
                ...
                {change ? (
                  <div className="change-inputs">
                    ...
                    <input
                      ...
                      size={7}
                      maxLength={6}
                      id="new_height_inches"
                    ></input>
                    <br></br>
                    <button
                      value="change-height"
                      id="change-height"
                      onClick={submit_height_change}
                    >
                      Submit
                    </button>
                  </div>
                ...
                {change ? (
                  <div className="change-inputs">
                    <select id="sexual-orientation-select">
                      ...
                      {(profile_page.gender === "Female" ||
                        profile_page.gender === "Non-binary" ||
                        profile_page.gender !== "Male") && (
                        <option value="Homosexual (Lesbian)">
                          Homosexual (Lesbian)
                        </option>
                      )}
                      {(profile_page.gender === "Male" ||
                    ...
                    <br></br>
                    <button
                      value="change-sexual-orientation"
                      id="change-sexual-orientation"
                      onClick={submit_sexual_orientation_change}
                    >
                      Submit
                    </button>
                  </div>
                ...
                {change ? (
                  <div className="change-inputs">
                    ...
                    <br></br>
                    <button
                      value="change-relationship-status"
                      id="change-relationship-status"
                      onClick={submit_relationship_status_change}
                    >
                      Submit
                    </button>
                  </div>
                ...
                {change ? (
                  <div className="change-inputs">
                    <textarea
                      ...
                      onChange={(e) => {
                        handle_bio_text();
                        setCurBioCharCount(e.target.value.length);
                      }}
                      maxLength={300}
                    ></textarea>
                    <br></br>
                ...
                >
                  ...
                  <div>
                    {!change ? (
                      <button
                        id="change-profile-pic"
                        onClick={display_change}
                        style={{ marginRight: "5rem", marginLeft: "5rem" }}
                      >
                        <IoPencilSharp color="black" />
                      </button>
                    ) : (
                      <button
                        id="change-profile-pic"
                  ...
                  <div>
                    {!change ? (
                      <button
                        id="change-profile-pic"
                        onClick={display_change}
                        style={{ padding: "5px 10px", marginRight: "1rem" }}
                      >
                        <IoPencilSharp color="black" />
                      </button>
                    ) : (
